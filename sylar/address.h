#ifndef __SYLAR_ADDRESS_H
#define __SYLAR_ADDRESS_H
...
public:
    ...
    static bool GetInterfaceAddresses(std::multimap<std::string,
        std::pair<Address::ptr, uint32_t>>& resutl, 
...
public:
    ...
    static IPv6Address::ptr Create(const char* address = INADDR_ANY, uint16_t port = 0);
    IPv6Address();
