...
void LogAppender::setFormatter(const std::string& formatter) {
    sylar::LogFormatter::ptr new_val(new sylar::LogFormatter(formatter));
    if(new_val->isError()) {
        std::cout << "Logger setFormatter name=" << "NULL" << "value= "
